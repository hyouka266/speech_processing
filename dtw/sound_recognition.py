...
y1, sr1 = librosa.load('audio_samples/elias_warping_cut.m4a')
y2, sr2 = librosa.load('audio_samples/elias_leader_cut.m4a')
y3, sr3 = librosa.load('audio_samples/chris_warping_cut.m4a')
y4, sr4 = librosa.load('audio_samples/chris_follow_cut.m4a')
yX, srX = librosa.load('audio_samples/full_sentence5.m4a')
